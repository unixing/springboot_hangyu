...
<head>
    ...
    <link href="/css/css<%=request.getSession().getServletContext().getAttribute("versionn") %>/hlcs.css" rel="stylesheet">
...
<script type="text/javascript">
    ...
    window.HLCS_COLOR = {
        ...
        ykt: '#3b5582',
        line: '#fff',
        area0: 'rgba(68,85,161,0.2)',
        area1: 'rgba(68,85,161,0.2)'
    }
...
<!--     【首页样式】增加右侧查询图标    2017-3-29 -->
    ...
    <div id="cs_tag" class="cs_tag">
        <div id='cs_tagItem1'>
            ...
            <div class="cs_tagPoint cs_tagWay"><span>&#xe6c5;</span>推荐选择机场</div>
...
<!-- 高级筛选   by：long   2017/9/27 -->
    <div id="advanced-filter-box">
        <div class="advanced-filter-turn" id="advanced-filter-turn" title="高级筛选">
            <i>&#xe6d2;</i>
            <%-- <i>&#xe6c2;</i> --%>
        </div>
        <div id="advanced-filter-container" class="advanced-filter-box">
            <p class="af-header">高级筛选</p>
            <span id="af-pramas-reseter" class="af-pramas-reset" title="重置筛选"><i>&#xe6d8;</i></span>
            <div class="af-body">
                <h4>飞行区等级</h4>
                <div class="af-checklist-box" data="fly_area_grade">
                    <span class="af-checklist-item">1A</span>
                    <span class="af-checklist-item">1B</span>
                    <span class="af-checklist-item">1C</span>
                    <span class="af-checklist-item">2A</span>
                    <span class="af-checklist-item">2B</span>
                    <span class="af-checklist-item">2C</span>
                    <span class="af-checklist-item">3A</span>
                    <span class="af-checklist-item">3B</span>
                    <span class="af-checklist-item">3C</span>
                    <span class="af-checklist-item">3D</span>
                    <span class="af-checklist-item">4C</span>
                    <span class="af-checklist-item">4D</span>
                    <span class="af-checklist-item">4E</span>
                    <span class="af-checklist-item">4F</span>
                    <span class="af-checklist-item" style="visibility: hidden;">4G</span>
                    <span class="af-checklist-item" style="visibility: hidden;">4G</span>
                </div>
                <h4>上一年吞吐量</h4>
                <div class="af-input-box" data="lastyear_person">
                    <input class="af-input-box-item" id="lastyear-person-a" type="text" maxlength="9" value="" placeholder="0">
                    ~
                    <input class="af-input-box-item" id="lastyear-person-b" type="text" maxlength="9" value="" placeholder="999999999">
                </div>
                <h4>机场类型</h4>
                <div class="af-checklist-box" data="airport_type">
                    <span class="af-checklist-item">高原机场</span>
                    <span class="af-checklist-item">特殊机场</span>
                    <span class="af-checklist-item">口岸机场</span>
                    <span class="af-checklist-item">协调机场</span>               
                </div>
                <div class="af-checklist-box" data="airport_type">
                    <span class="af-checklist-item">非高原机场</span>
                    <span class="af-checklist-item">非特殊机场</span>
                    <span class="af-checklist-item">非口岸机场</span>
                    <span class="af-checklist-item">非协调机场</span>               
                </div>
                <h4>补贴政策</h4>
                <div class="af-checklist-box" data="subsidy_type">
                    <span class="af-checklist-item af-checklist-item-big">有补贴</span> 
                    <span class="af-checklist-item af-checklist-item-big">无补贴</span> 
                </div>
            </div>
            <div class="af-footer">
                <span class="afbtn" id="af-search-btn"><i>&#xe691;&nbsp;</i>查询目标机场</span>
            </div>
        </div>    
    </div>
