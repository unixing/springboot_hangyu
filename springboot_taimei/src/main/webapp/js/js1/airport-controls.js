$(function(){
    ...
    //机场选择控件
    $(".airport-controls-head>li").on("click",function(){
        $(this).css({"border-bottom":"2px solid white","color":"red"}).siblings().css({"border-bottom":"2px solid transparent","color":"red"});
        if($(this).attr("tag")){
            var tag=$(this).attr("tag").split(".");
            var name1="";
            for(var i=0;i<tag.length;i++){
                var serch="";
                if(tag[i]!="I"&&tag[i]!="O"&&tag[i]!="U"&&tag[i]!="V"){
                    name1+="<ul><li>"+tag[i]+"</li><li class='citySelection'>";
                }
                for(var j=0;j<nationalAirport.length;j++){
                    if(tag[i]==nationalAirport[j].initial){
                        serch+="<span>"+nationalAirport[j].airportName+"</span>"
                    }
                }
                name1+=serch+"</li></ul>";
            }
            $(".airport-controls-cont").html(name1);
        }
    });
    //打开机场控件
    $(".selectCity").on("click",function(){
        $(".selectCity").attr("tag","");
        $(this).attr("tag","tag");
        $(".airport-controls").css("display","block");
        setTimeout(function(){
            $("body").on("click",function(){
                $(".airport-controls").css("display","none");
                $("body").unbind("click")
            })
        },10)
    });
    //鼠标移出机场选择控件绑定点击隐藏事件
    $(".airport-controls,.selectCity").on("mouseout",function(){
        $("body").on("click",function(){
            $(".airport-controls").css("display","none");
            $("body").unbind("click")
        })
    ...
    //input选择机场
    $(".airport-controls-head>li,.psc-sr-head-select>li:nth-of-type(1)").on("click",function(){
        $(".citySelection").on("click","span",function(){
            for(var i=0;i<$(".selectCity").length;i++){
                if($(".selectCity").eq(i).attr("tag")=="tag"){
                    $(".selectCity").eq(i).attr({"value": $(this).html()});
                    $(".airport-controls").css("display","none");
                }
            }
        });
    ...
    //鼠标移入机场选择控件取消点击隐藏事件
    $(".airport-controls,.selectCity").on("mouseover",function(){
        $("body").unbind("click")
    });
    //热门城市与非热门城市切换
    $(".airport-controls-head>li:nth-of-type(1)").on("click",function(){
        $(".airport-controls-hot").css("display","block");
        $(".airport-controls-cont").css("display","none");
    });
    //热门城市与非热门城市切换
    $(".airport-controls-head>li:nth-of-type(1)").siblings().on("click",function(){
        $(".airport-controls-hot").css("display","none");
        $(".airport-controls-cont").css("display","block");
    });
    /*************************************键盘输入搜索****************************************************/
    //按键关闭选择控件
    $(".selectCity").on("keyup",function(e){
        if($.trim($(this).attr("value"))!=""){
            var varlues=$(this).attr("value").toUpperCase().split("");
            $(".airport-controls").css("display","none");
            var screen="";
            for(var i=0;i<nationalAirport.length;i++){
                var airsCity=nationalAirport[i].airportName.split("");//机场名字
                var airsCity1=nationalAirport[i].pinyin.toUpperCase().split("");//全拼音
                var airsCity2=nationalAirport[i].py.toUpperCase().split("");//首字母拼音
                var airsCity3=nationalAirport[i].code.toUpperCase().split("");//三字码
                if(new RegExp(varlues).test(airsCity)){
                    screen+="<ul class='screen-controls-one'><li><strong>"+nationalAirport[i].airportName+"</strong></li><li>("+nationalAirport[i].code+")</li><li>"+nationalAirport[i].pinyin+"</li></ul>";
                }else if(new RegExp(varlues).test(airsCity1)){
                    //screen+="<ul class="screen-controls-one"><li>成都双流</li> <li>(<strong>CT</strong>U)</li> <li>chengdushuangliu</li> </ul>";
                    console.log(airsCity1);
                }else if(new RegExp(varlues).test(airsCity2)){
                    console.log(airsCity2);
                }else if(new RegExp(varlues).test(airsCity3)){
                    console.log(airsCity3)
                }
                $(".screen-controls").html(screen);
            }
        }
